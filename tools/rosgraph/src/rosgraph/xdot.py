...
class XDotParser(DotParser):
    ...
    def handle_graph(self, attrs):
        ...
        xmin, ymin, xmax, ymax = [int(float(x)) for x in  bb.split(",")]
...
class DotWidget(gtk.DrawingArea):
    ...
    def on_rotate(self, action):
        if self.on_rotate_handler:
            self.on_rotate_handler(action)

    def set_on_rotate(self, handler):
        self.on_rotate_handler = handler
    # END ADDITIONS #################################################
...
class DotWindow(gtk.Window):
    ...
    def __init__(self, default_size):
        ...
        actiongroup.add_actions((
            # DISABLE ('Open', gtk.STOCK_OPEN, None, None, None, self.on_open),
            ('ZoomIn', gtk.STOCK_ZOOM_IN, None, None, None, self.widget.on_zoom_in),
            ('ZoomOut', gtk.STOCK_ZOOM_OUT, None, None, None, self.widget.on_zoom_out),
            ('ZoomFit', gtk.STOCK_ZOOM_FIT, None, None, None, self.widget.on_zoom_fit),
            ('Zoom100', gtk.STOCK_ZOOM_100, None, None, None, self.widget.on_zoom_100),
            #ADDITIONS #######################################
            ('Rotate', gtk.STOCK_REDO, "Rotate", None, None, self.widget.on_rotate),
        ))
